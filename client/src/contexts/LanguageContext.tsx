...
const translations = {
  en: {
    ...
    // Detention Page
    "detention.hero.title": "Someone You Know Was Detained by ICE?",
    "detention.hero.subtitle": "Time is critical. Follow these immediate steps to help protect your loved one's rights and get them legal representation as quickly as possible.",
    "detention.step1.title": "Stay Calm and Think Clearly",
    "detention.step1.desc": "ICE detention is frightening, but panic will not help. Take a deep breath and focus on the immediate steps you need to take to protect your loved one.",
    "detention.step1.know_title": "What you need to know:",
    "detention.step1.point1": "Your loved one has the right to remain silent",
    "detention.step1.point2": "They should NOT sign any documents without legal representation",
    "detention.step1.point3": "They can request a lawyer at any time",
    "detention.step1.point4": "They have the right to make a phone call",
    "detention.step1.point5": "Everything they say can be used against them in court",
    "detention.step2.title": "Get the Detainee's Alien Number (A Number) and NTA",
    "detention.step2.desc": "Every person detained by ICE receives an identification bracelet with a unique Alien number (A number). They will also receive a Notice to Appear (NTA), which is the document that starts removal proceedings.",
    "detention.step2.call_title": "If they call you:",
    "detention.step2.call_desc": "Ask them to read you the A number on their bracelet. Write it down immediately and keep it safe. Ask if they received a Notice to Appear (NTA).",
    "detention.step2.no_call_title": "If you don't hear from them:",
    "detention.step2.no_call_desc": "You can still locate them using the ICE Detainee Locator (see Step 4 below).",
    "detention.step2.warning": "Important: Keep the A number safe. You'll need it to check their case status and communicate with ICE.",
    "detention.step3.title": "Call Ana Immediately for Legal Representation",
    "detention.step3.desc": "The sooner your loved one has legal representation, the better. Ana Paola Amaral-Muschlitz specializes in immigration detention cases and can provide immediate assistance.",
    "detention.step3.hotline_title": "EMERGENCY DETENTION HOTLINE",
    "detention.step3.available": "Available 24/7 for urgent detention cases",
    "detention.step3.what_to_tell": "What to tell Ana:",
    "detention.step3.point1": "Your loved one's full name",
    "detention.step3.point2": "Their Alien number (A number) (if you have it)",
    "detention.step3.point3": "Where they were detained",
    "detention.step3.point4": "Any medical or mental health conditions",
    "detention.step3.point5": "Whether they have a criminal history",
    "detention.step4.title": "Use the ICE Detainee Locator",
    "detention.step4.desc": "The ICE Detainee Locator is a free government tool that allows you to find where your loved one is being held and get basic information about their case.",
    "detention.step4.button": "Launch ICE Detainee Locator",
    "detention.step5.title": "Check Immigration Court Case Status",
    "detention.step5.desc": "Your loved one's immigration case will be handled in immigration court. You can check the status of their case online using the EOIR system.",
    "detention.step5.button": "Check EOIR Case Status",
    "detention.dos.title": "DO",
    "detention.dos.point1": "Call Ana immediately",
    "detention.dos.point2": "Keep the A number safe",
    "detention.dos.point3": "Check the ICE locator regularly",
    "detention.dos.point4": "Attend all court hearings",
    "detention.dos.point5": "Provide documents to your attorney",
    "detention.donts.title": "DON'T",
    "detention.donts.point1": "Sign documents without legal advice",
    "detention.donts.point2": "Promise to pay a bond you can't afford",
    "detention.donts.point3": "Discuss the case with anyone except your attorney",
  ...
  es: {
    ...
    "attorneys.reggie.role": "Abogado de Litigio de Inmigración Complejo",
    "attorneys.reggie.bio": "Especializado en litigios de inmigración complejos con amplia experiencia en procedimientos de apelación, litigios en cortes federales y casos de inmigración desafiantes que requieren estrategias legales avanzadas.",
    ...
    "attorneys.cta.desc": "Cada día en detención importa. Contáctenos hoy para una consulta gratuita y aprenda cómo podemos ayudar a asegurar su liberación y luchar por sus derechos.",
    ...
    "guide.5.desc": "Una mirada temprana a los cambios propuestos al código fiscal y cómo prepararse.",
    ...
    "bond.placeholder.relation": "ej. Hermano, Esposa",
    ...
    // Detention Page
    "detention.hero.title": "¿Alguien que Conoce Fue Detenido por ICE?",
    "detention.hero.subtitle": "El tiempo es crítico. Siga estos pasos inmediatos para ayudar a proteger los derechos de su ser querido y conseguirle representación legal lo más rápido posible.",
    "detention.step1.title": "Mantenga la Calma y Piense Claramente",
    "detention.step1.desc": "La detención de ICE es aterradora, pero el pánico no ayudará. Respire profundo y concéntrese en los pasos inmediatos que debe tomar para proteger a su ser querido.",
    "detention.step1.know_title": "Lo que necesita saber:",
    "detention.step1.point1": "Su ser querido tiene derecho a permanecer en silencio",
    "detention.step1.point2": "NO deben firmar ningún documento sin representación legal",
    "detention.step1.point3": "Pueden solicitar un abogado en cualquier momento",
    "detention.step1.point4": "Tienen derecho a hacer una llamada telefónica",
    "detention.step1.point5": "Todo lo que digan puede ser usado en su contra en la corte",
    "detention.step2.title": "Obtenga el Número de Extranjero (Número A) y NTA",
    "detention.step2.desc": "Cada persona detenida por ICE recibe un brazalete de identificación con un número de Extranjero único (número A). También recibirán un Aviso de Comparecencia (NTA), que es el documento que inicia los procedimientos de remoción.",
    "detention.step2.call_title": "Si le llaman:",
    "detention.step2.call_desc": "Pídales que le lean el número A en su brazalete. Anótelo inmediatamente y guárdelo en un lugar seguro. Pregunte si recibieron un Aviso de Comparecencia (NTA).",
    "detention.step2.no_call_title": "Si no sabe de ellos:",
    "detention.step2.no_call_desc": "Aún puede localizarlos usando el Localizador de Detenidos de ICE (ver Paso 4 abajo).",
    "detention.step2.warning": "Importante: Guarde el número A en un lugar seguro. Lo necesitará para verificar el estado de su caso y comunicarse con ICE.",
    "detention.step3.title": "Llame a Ana Inmediatamente para Representación Legal",
    "detention.step3.desc": "Cuanto antes tenga representación legal su ser querido, mejor. Ana Paola Amaral-Muschlitz se especializa en casos de detención migratoria y puede brindar asistencia inmediata.",
    "detention.step3.hotline_title": "LÍNEA DE EMERGENCIA DE DETENCIÓN",
    "detention.step3.available": "Disponible 24/7 para casos urgentes de detención",
    "detention.step3.what_to_tell": "Qué decirle a Ana:",
    "detention.step3.point1": "Nombre completo de su ser querido",
    "detention.step3.point2": "Su número de Extranjero (número A) (si lo tiene)",
    "detention.step3.point3": "Dónde fueron detenidos",
    "detention.step3.point4": "Cualquier condición médica o de salud mental",
    "detention.step3.point5": "Si tienen antecedentes penales",
    "detention.step4.title": "Use el Localizador de Detenidos de ICE",
    "detention.step4.desc": "El Localizador de Detenidos de ICE es una herramienta gubernamental gratuita que le permite encontrar dónde está detenido su ser querido y obtener información básica sobre su caso.",
    "detention.step4.button": "Abrir Localizador de Detenidos de ICE",
    "detention.step5.title": "Verifique el Estado del Caso en la Corte de Inmigración",
    "detention.step5.desc": "El caso de inmigración de su ser querido será manejado en la corte de inmigración. Puede verificar el estado de su caso en línea usando el sistema EOIR.",
    "detention.step5.button": "Verificar Estado del Caso EOIR",
    "detention.dos.title": "HACER",
    "detention.dos.point1": "Llamar a Ana inmediatamente",
    "detention.dos.point2": "Guardar el número A en un lugar seguro",
    "detention.dos.point3": "Verificar el localizador de ICE regularmente",
    "detention.dos.point4": "Asistir a todas las audiencias judiciales",
    "detention.dos.point5": "Proporcionar documentos a su abogado",
  ...
  pt: {
    ...
    "footer.subscribe_text": "Inscreva-se para receber informações legais e atualizações do escritório.",
    ...
    "home.latest_insights": "Últimas Perspectivas Legais",
    ...
    "practice.crimmigration_desc": "Defendendo não-cidadãos que enfrentam acusações criminais que afetam o status imigratório.",
    ...
    "vanity.description": "No caso de uma detenção inesperada pelo ICE, cada segundo conta. Memorizar 1-844-ICE-FREE (1-844-262-5442) garante que você ou seus entes queridos possam se conectar instantaneamente com nossa equipe de defesa de deportação. Estamos disponíveis para fornecer orientação urgente e representação para lutar por sua libertação.",
    ...
    "attorneys.balaiz.bio": "Experiente em questões de litígio civil, incluindo disputas contratuais, reivindicações de propriedade e casos civis complexos. Fornece representação legal especializada para clientes que precisam de aconselhamento especializado em direito civil.",
    "attorneys.values.title": "Nossos Valores",
    "attorneys.values.justice": "Justiça para Todos",
    "attorneys.values.justice_desc": "Acreditamos que cada pessoa merece representação legal de qualidade, independentemente de suas circunstâncias.",
    ...
    "knowledge.subtitle": "Perspectivas jurídicas especializadas, guias detalhados e recursos práticos para ajudá-lo a navegar em paisagens jurídicas complexas.",
    ...
    "knowledge.newsletter.desc": "Inscreva-se em nosso boletim mensal para receber as últimas perspectivas jurídicas, notícias do escritório e atualizações regulatórias diretamente em sua caixa de entrada.",
    ...
    "guide.3.desc": "Decidindo qual mecanismo de proteção é o adequado para sua inovação.",
    ...
    "guide.5.desc": "Um olhar antecipado sobre as mudanças propostas no código tributário e como se preparar.",
    ...
    "home.insight.2.title": "Como Pagar uma Fiança para um Parente Detido",
    ...
    "bond.placeholder.relation": "ex: Irmão, Esposa",
    "bond.placeholder.status": "ex: Cidadão dos EUA, Residente Permanente",
    "bond.placeholder.income": "Renda Anual USD",
    "bond.sending": "Enviando...",

    // Consultation
    "consultation.title": "Solicitar uma Consulta",
    "consultation.subtitle": "Por favor, forneça detalhes sobre seu assunto jurídico para que possamos designar o advogado mais apropriado.",
    ...
    "consultation.confidentiality": "Todas as informações fornecidas são estritamente confidenciais e protegidas pelo privilégio advogado-cliente.",
    ...
    "consultation.label.description": "Breve Descrição de Sua Situação Imigratória",
    "consultation.placeholder.description": "Por favor, descreva sua situação (ex: Você tem uma data de corte? Está detido?)",
    "consultation.label.urgency": "Nível de Urgência",
    "consultation.urgency.low": "Padrão (Planejando com antecedência)",
    ...
    "consultation.option.morning": "Manhã (9AM - 12PM)",
    "consultation.option.afternoon": "Tarde (1PM - 5PM)",
    "consultation.option.evening": "Noite (Após 5PM)",
    ...
    "consultation.success.desc": "Obrigado por entrar em contato com a Amaral Law. Nossa equipe de admissão revisará seus detalhes e entrará em contato dentro de 24 horas para agendar sua consulta.",
    "consultation.button.home": "Voltar ao Início",

    // Detention Page
    "detention.hero.title": "Alguém que Você Conhece Foi Detido pelo ICE?",
    "detention.hero.subtitle": "O tempo é crítico. Siga estes passos imediatos para ajudar a proteger os direitos do seu ente querido e conseguir representação legal o mais rápido possível.",
    "detention.step1.title": "Mantenha a Calma e Pense Claramente",
    "detention.step1.desc": "A detenção pelo ICE é assustadora, mas o pânico não ajudará. Respire fundo e concentre-se nos passos imediatos que você precisa tomar para proteger seu ente querido.",
    "detention.step1.know_title": "O que você precisa saber:",
    "detention.step1.point1": "Seu ente querido tem o direito de permanecer em silêncio",
    "detention.step1.point2": "Eles NÃO devem assinar nenhum documento sem representação legal",
    "detention.step1.point3": "Eles podem solicitar um advogado a qualquer momento",
    "detention.step1.point4": "Eles têm o direito de fazer uma ligação telefônica",
    "detention.step1.point5": "Tudo o que eles disserem pode ser usado contra eles no tribunal",
    "detention.step2.title": "Obtenha o Número de Estrangeiro (Número A) e NTA",
    "detention.step2.desc": "Cada pessoa detida pelo ICE recebe uma pulseira de identificação com um número de Estrangeiro único (número A). Eles também receberão um Aviso de Comparecimento (NTA), que é o documento que inicia os processos de remoção.",
    "detention.step2.call_title": "Se eles ligarem para você:",
    "detention.step2.call_desc": "Peça para eles lerem o número A na pulseira. Anote imediatamente e guarde em um local seguro. Pergunte se eles receberam um Aviso de Comparecimento (NTA).",
    "detention.step2.no_call_title": "Se você não tiver notícias deles:",
    "detention.step2.no_call_desc": "Você ainda pode localizá-los usando o Localizador de Detentos do ICE (veja o Passo 4 abaixo).",
    "detention.step2.warning": "Importante: Guarde o número A em um local seguro. Você precisará dele para verificar o status do caso e se comunicar com o ICE.",
    "detention.step3.title": "Ligue para Ana Imediatamente para Representação Legal",
    "detention.step3.desc": "Quanto mais cedo seu ente querido tiver representação legal, melhor. Ana Paola Amaral-Muschlitz é especialista em casos de detenção imigratória e pode fornecer assistência imediata.",
    "detention.step3.hotline_title": "LINHA DE EMERGÊNCIA DE DETENÇÃO",
    "detention.step3.available": "Disponível 24/7 para casos urgentes de detenção",
    "detention.step3.what_to_tell": "O que dizer para Ana:",
    "detention.step3.point1": "Nome completo do seu ente querido",
    "detention.step3.point2": "O número de Estrangeiro (número A) (se você tiver)",
    "detention.step3.point3": "Onde eles foram detidos",
    "detention.step3.point4": "Quaisquer condições médicas ou de saúde mental",
    "detention.step3.point5": "Se eles têm antecedentes criminais",
    "detention.step4.title": "Use o Localizador de Detentos do ICE",
    "detention.step4.desc": "O Localizador de Detentos do ICE é uma ferramenta governamental gratuita que permite encontrar onde seu ente querido está detido e obter informações básicas sobre o caso.",
    "detention.step4.button": "Abrir Localizador de Detentos do ICE",
    "detention.step5.title": "Verifique o Status do Caso no Tribunal de Imigração",
    "detention.step5.desc": "O caso de imigração do seu ente querido será tratado no tribunal de imigração. Você pode verificar o status do caso online usando o sistema EOIR.",
    "detention.step5.button": "Verificar Status do Caso EOIR",
    "detention.dos.title": "FAZER",
    "detention.dos.point1": "Ligar para Ana imediatamente",
    "detention.dos.point2": "Guardar o número A em um local seguro",
    "detention.dos.point3": "Verificar o localizador do ICE regularmente",
    "detention.dos.point4": "Comparecer a todas as audiências judiciais",
    "detention.dos.point5": "Fornecer documentos ao seu advogado",
